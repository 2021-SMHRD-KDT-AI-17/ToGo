...
<html>
	...
	Member loginMember =(Member)session.getAttribute("loginMember");  //우리가만든 member import해야함!!
						...
						<!-- Q1. 회원가입 기능 만들기 -->
							<li><h5>회원가입</h5></li>
								<form action="memberInsert" method="post">
									<li><input type="text"  placeholder="Email을 입력하세요" name="email"  id="inputE"></li>
							...
							<section id="two">
								<div class="inner">
									...
									<ul class="actions">
										...
										<li><%=loginMember.getEmail() %>님 안녕하세요!</li>
										...
										<li><a href="deleteAllMessage?email=<%=loginMember.getEmail() %>" class="button next scrolly">전체삭제하기</a></li>
						...
						<div class="inner">
							...
							<!-- 다른 사람의 DB에 메시지 저장해보기! -->
								...
								<div class="field half first">
									...
									<input type="text" name="sendE" id="name" value="<%=loginMember.getEmail()%>" placeholder="보내는 사람 이름" />
								...
								<%	}%>
									...
									<div class="field half">
										...
										<input type="text" name="receiveE" id="email" placeholder="받는 사람 이메일"/>
									</div>
